...
@router.get("/product-process-requirements/")
...
@router.get("/product-process-requirements/{requirement_id}")
...
@router.post("/product-process-requirements/")
...
@router.put("/product-process-requirements/{requirement_id}")
...
@router.delete("/product-process-requirements/{requirement_id}")
